            ...
            for s in self.symbol_list:
                ...
                for order in [o for o in self.port.order_history if o['symbol'] == s]:
                        if order['direction'] =='BUY':
                            if  bars[-1][5]>order['price']+3*self.N*data['atr'] or bars[-1][5]<order['price']-self.N*data['atr'] or order['flag']==1000:
                            ...
                            if  bars[-1][5]<order['price']-3*self.N*data['atr'] or bars[-1][5]>order['price']+self.N*data['atr'] or order['flag']==2000:
                                self.events.put(SignalEvent(s, timestamp, 'EXIT',0))

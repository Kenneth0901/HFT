...
from strategy import MixTechStrategy, BollandMACDStrategy, StableTrendStrategy
...
bars = HistoricDataHandler(events, r'./bar_data', ['ETHUSDT'])
port = NaivePortfolio(bars, events, start_date)
strategy = StableTrendStrategy(bars, port, events)

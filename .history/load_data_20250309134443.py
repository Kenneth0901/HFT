...
start_str = "20240101 00:00"
end_str = "20250309 00:00"
start_time = int(datetime.strptime(end_str, "%Y%m%d %H:%M").timestamp()*1000)
end = int(datetime.strptime(end_str, "%Y%m%d %H:%M").timestamp()*1000)
